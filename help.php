...
<section class="hero-about position-relative">
    ...
    <div class="container position-relative">
        <div class="row justify-content-center text-center">
            <div class="col-lg-10">
                <h1 class="display-4 fw-bolder mb-2 haygo-about">
                    Hay Go Help Center
                </h1>
...
<main class="py-5">
    ...
    <div class="container faq-container">
        ...
        <div class="text-center mt-5 p-4 p-md-5 rounded-4 shadow-lg"
            style="background: linear-gradient(135deg, #d2c0aeff 0%, #8a7563ff 100%); border: 1px solid #D1E8F4;">
            <h3 class="h2 fw-bolder mb-3 haygo-primary">Need Immediate Help?</h3>
            <p class="lead haygo-about mb-4 max-w-lg mx-auto">
                If our FAQs didn't cover it, our 24/7 Hay Go support team is standing by. Start a live chat now!
            </p>
            <button type="button" class="l-button btn btn-lg" data-bs-toggle="modal" data-bs-target="#chatModal">
