    ...
    <nav class="flex-grow-1">
        <ul class="nav flex-column space-y-2">
            ...
            <li class="nav-item mb-2">
                ...
                <a href="reports.php" class="nav-link d-flex align-items-center gap-3 p-3 rounded-3 bg-rental-primary text-white fw-semibold shadow-sm active-nav">
...
<main class="main-content flex-grow-1 p-4 p-md-5">
    ...
    <!-- Header -->
    <header class="mb-5">
        <h2 class="fs-2 fw-bold text-dark">Reports & Analytics</h2>
