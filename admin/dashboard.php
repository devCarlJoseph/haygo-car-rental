...
?>
    ...
    <div class="wrapper" style="background: #EBE7E4;">
                ...
                <ul class="sidebar-nav mt-3">
                    ...
                    <li class="sidebar-item">
                        <a data-bs-target="#ecommerce" data-bs-toggle="collapse" class="sidebar-link collapsed">
                            ...
                            <li class="sidebar-item">
                                <a href="invoice.html" class="sidebar-link" style="color: #FDE9DF;">Invoice</a>
                            </li>
                    </li>
                </ul>
            </div>
        ...
        <div class="main">
            <nav class="navbar navbar-expand navbar-bg" style="height: 4.188rem;">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="navbar-nav navbar-align ">
                        <li class="nav-item dropdown">
                            <img src="../src/assets/images/admin_pp.jpg"
                                class="img-fluid rounded-circle me-1 mt-n2 mb-n2" width="40" height="40" />
                ...
                <div>
                    <button class="border border-none text-white "
                        style=" margin-bottom: 0.2rem; width: 3.9rem; height: 1.7rem; font-size: 0.725rem; background: #E99670; border-radius: 5px;"><a href="log-in.php" style="text-decoration: none; color: white;">Sign
                        Out</a></button>
                </div>
            </nav>
