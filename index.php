            ...
            <div class="d-flex justify-content-center align-items-center gap-5" style="margin-top: 5rem;">
                ...
                <div class="" style="width: 57.438rem; height: 25.125rem;">
                    <div class="d-flex justify-content-center align-items-center" style="gap: 2rem;">
                        <div class="card"
                            ...
                            <div class="d-flex justify-content-center align-items-center mt-2">
                                <div class="rounded-4" style="width: 15.813rem; height: 2.813rem; background: #F5E9E3;">
                    ...
                    <div class="d-flex justify-content-center align-items-center gap-2 mt-3">
                        <div class="rounded-5" style="width: 2.188rem; height: 0.438rem; background: #B9B4B4;"></div>
                        <div class="bg-white rounded-5" style="width: 1.563rem; height: 0.438rem;"></div>
                        <div class="bg-white rounded-5" style="width: 1.563rem; height: 0.438rem;"></div>
                    </div>
